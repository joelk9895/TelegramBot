...
class VersionsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createVersionResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.Version');
        const createVersionMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.CreateVersionOperationMetadata');
        const loadVersionResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const loadVersionMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        this.descriptors.longrunning = {
            createVersion: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createVersionResponse.decode.bind(createVersionResponse), createVersionMetadata.decode.bind(createVersionMetadata)),
            loadVersion: new this._gaxModule.LongrunningDescriptor(this.operationsClient, loadVersionResponse.decode.bind(loadVersionResponse), loadVersionMetadata.decode.bind(loadVersionMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Versions', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.versionsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Versions')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Versions, this._opts, this._providedCustomServicePath);
    ...
    updateVersion(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'version.name': (_a = request.version.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    compareVersions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                base_version: (_a = request.baseVersion) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
     ...
     */
    async checkCreateVersionProgress(name) {
    ...
    loadVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkLoadVersionProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
