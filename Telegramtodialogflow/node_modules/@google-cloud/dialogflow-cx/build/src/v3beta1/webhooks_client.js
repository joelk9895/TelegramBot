 ...
 */
const gapicConfig = require("./webhooks_client_config.json");
...
class WebhooksClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            projectLocationAgentEnvironmentSessionPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/environments/{environment}/sessions/{session}'),
            ...
            projectLocationAgentSessionPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/sessions/{session}'),
        ...
        this.descriptors.page = {
            listWebhooks: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'webhooks'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Webhooks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.webhooksStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Webhooks')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Webhooks, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of webhooksStubMethods) {
            const callPromise = this.webhooksStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getWebhook(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createWebhook(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateWebhook(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'webhook.name': (_a = request.webhook.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateWebhook(request, options, callback);
    }
    deleteWebhook(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listWebhooks(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    listWebhooksStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listWebhooks.createStream(this.innerApiCalls.listWebhooks, request, callSettings);
    }
    /**
     ...
     */
    listWebhooksAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listWebhooks.asyncIterate(this.innerApiCalls['listWebhooks'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=webhooks_client.js.map