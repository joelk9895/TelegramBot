 ...
 * `src/v3beta1/flows_client_config.json`.
...
class FlowsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const importFlowResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ImportFlowResponse');
        const importFlowMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        const exportFlowResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportFlowResponse');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Flows', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.flowsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Flows')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Flows, this._opts, this._providedCustomServicePath);
