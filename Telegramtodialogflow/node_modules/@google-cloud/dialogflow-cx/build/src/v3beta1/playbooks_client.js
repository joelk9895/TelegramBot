...
exports.PlaybooksClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v3beta1/playbooks_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./playbooks_client_config.json");
const version = require('../../../package.json').version;
/**
 *  Service for managing
 *  {@link protos.google.cloud.dialogflow.cx.v3beta1.Playbook|Playbooks}.
 * @class
 * @memberof v3beta1
 */
class PlaybooksClient {
     ...
     *     const client = new PlaybooksClient({fallback: true}, gax);
     *     ```
     */
    constructor(opts, gaxInstance) {
        ...
        this.pathTemplates = {
            ...
            examplePathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/examples/{example}'),
            ...
            playbookPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}'),
            playbookVersionPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}/versions/{version}'),
            ...
            projectLocationAgentFlowTransitionRouteGroupPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/flows/{flow}/transitionRouteGroups/{transition_route_group}'),
            ...
            projectLocationAgentTransitionRouteGroupPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/transitionRouteGroups/{transition_route_group}'),
            ...
            toolPathTemplate: new this._gaxModule.PathTemplate('projects/{project}/locations/{location}/agents/{agent}/tools/{tool}'),
        ...
        this.descriptors.page = {
            listPlaybooks: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'playbooks'),
            listPlaybookVersions: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'playbookVersions'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Playbooks', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.playbooksStub) {
            return this.playbooksStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.cx.v3beta1.Playbooks.
        this.playbooksStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Playbooks')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Playbooks, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of playbooksStubMethods) {
            const callPromise = this.playbooksStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createPlaybook(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    deletePlaybook(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getPlaybook(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updatePlaybook(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'playbook.name': (_a = request.playbook.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updatePlaybook(request, options, callback);
    }
    createPlaybookVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    getPlaybookVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    deletePlaybookVersion(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listPlaybooks(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.cx.v3beta1.Playbook|Playbook} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
     *   We recommend using `listPlaybooksAsync()`
    ...
    listPlaybooksStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listPlaybooks.createStream(this.innerApiCalls.listPlaybooks, request, callSettings);
    }
    /**
     ...
     *   {@link protos.google.cloud.dialogflow.cx.v3beta1.Playbook|Playbook}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v3beta1/playbooks.list_playbooks.js</caption>
     * region_tag:dialogflow_v3beta1_generated_Playbooks_ListPlaybooks_async
     */
    listPlaybooksAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listPlaybooks.asyncIterate(this.innerApiCalls['listPlaybooks'], request, callSettings);
    }
    listPlaybookVersions(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion|PlaybookVersion} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     *   times as needed. Note that it can affect your quota.
     *   We recommend using `listPlaybookVersionsAsync()`
     *   method described below for async iteration which you can stop as needed.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     */
    listPlaybookVersionsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listPlaybookVersions.createStream(this.innerApiCalls.listPlaybookVersions, request, callSettings);
    }
    /**
     ...
     *   An iterable Object that allows {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Iteration_protocols | async iteration }.
     *   When you iterate the returned iterable, each element will be an object representing
     *   {@link protos.google.cloud.dialogflow.cx.v3beta1.PlaybookVersion|PlaybookVersion}. The API will be called under the hood as needed, once per the page,
     *   so you can stop the iteration when you don't need more results.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#auto-pagination | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v3beta1/playbooks.list_playbook_versions.js</caption>
     * region_tag:dialogflow_v3beta1_generated_Playbooks_ListPlaybookVersions_async
     */
    listPlaybookVersionsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listPlaybookVersions.asyncIterate(this.innerApiCalls['listPlaybookVersions'], request, callSettings);
    }
    /**
...
exports.PlaybooksClient = PlaybooksClient;
//# sourceMappingURL=playbooks_client.js.map