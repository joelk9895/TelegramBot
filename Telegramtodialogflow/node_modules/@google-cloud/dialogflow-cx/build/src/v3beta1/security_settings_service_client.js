...
exports.SecuritySettingsServiceClient = void 0;
 ...
 */
const gapicConfig = require("./security_settings_service_client_config.json");
...
class SecuritySettingsServiceClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listSecuritySettings: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'securitySettings'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.SecuritySettingsService', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.securitySettingsServiceStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.SecuritySettingsService')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1
                    .SecuritySettingsService, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of securitySettingsServiceStubMethods) {
            const callPromise = this.securitySettingsServiceStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createSecuritySettings(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.createSecuritySettings(request, options, callback);
    }
    getSecuritySettings(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateSecuritySettings(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'security_settings.name': (_a = request.securitySettings.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateSecuritySettings(request, options, callback);
    }
    deleteSecuritySettings(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deleteSecuritySettings(request, options, callback);
    }
    listSecuritySettings(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.cx.v3beta1.SecuritySettings|SecuritySettings} on 'data' event.
    ...
    listSecuritySettingsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listSecuritySettings.createStream(this.innerApiCalls.listSecuritySettings, request, callSettings);
    }
    /**
     ...
     *   {@link protos.google.cloud.dialogflow.cx.v3beta1.SecuritySettings|SecuritySettings}. The API will be called under the hood as needed, once per the page,
    ...
    listSecuritySettingsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listSecuritySettings.asyncIterate(this.innerApiCalls['listSecuritySettings'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=security_settings_service_client.js.map