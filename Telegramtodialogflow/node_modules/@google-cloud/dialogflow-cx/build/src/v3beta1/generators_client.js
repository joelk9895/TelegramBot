 ...
 * `src/v3beta1/generators_client_config.json`.
...
class GeneratorsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Generators', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.generatorsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Generators')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Generators, this._opts, this._providedCustomServicePath);
    ...
    updateGenerator(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'generator.name': (_a = request.generator.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
...
//# sourceMappingURL=generators_client.js.map