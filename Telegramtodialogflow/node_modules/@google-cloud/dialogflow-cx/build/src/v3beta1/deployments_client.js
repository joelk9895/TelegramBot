 ...
 * `src/v3beta1/deployments_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./deployments_client_config.json");
...
class DeploymentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listDeployments: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'deployments'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Deployments', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.deploymentsStub) {
            return this.deploymentsStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.cx.v3beta1.Deployments.
        this.deploymentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Deployments')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Deployments, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of deploymentsStubMethods) {
            const callPromise = this.deploymentsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getDeployment(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    listDeployments(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listDeploymentsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listDeployments.createStream(this.innerApiCalls.listDeployments, request, callSettings);
    }
    /**
    ...
    listDeploymentsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listDeployments.asyncIterate(this.innerApiCalls['listDeployments'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=deployments_client.js.map