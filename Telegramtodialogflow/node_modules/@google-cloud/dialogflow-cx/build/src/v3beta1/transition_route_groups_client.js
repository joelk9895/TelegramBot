...
exports.TransitionRouteGroupsClient = void 0;
 ...
 */
const gapicConfig = require("./transition_route_groups_client_config.json");
...
class TransitionRouteGroupsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listTransitionRouteGroups: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'transitionRouteGroups'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroups', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.transitionRouteGroupsStub) {
            return this.transitionRouteGroupsStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroups.
        this.transitionRouteGroupsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.TransitionRouteGroups')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1
                    .TransitionRouteGroups, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of transitionRouteGroupsStubMethods) {
            const callPromise = this.transitionRouteGroupsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getTransitionRouteGroup(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createTransitionRouteGroup(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateTransitionRouteGroup(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'transition_route_group.name': (_a = request.transitionRouteGroup.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateTransitionRouteGroup(request, options, callback);
    }
    deleteTransitionRouteGroup(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deleteTransitionRouteGroup(request, options, callback);
    }
    listTransitionRouteGroups(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.listTransitionRouteGroups(request, options, callback);
    }
    /**
     ...
     */
    listTransitionRouteGroupsStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listTransitionRouteGroups.createStream(this.innerApiCalls.listTransitionRouteGroups, request, callSettings);
    }
    /**
     ...
     */
    listTransitionRouteGroupsAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTransitionRouteGroups.asyncIterate(this.innerApiCalls['listTransitionRouteGroups'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=transition_route_groups_client.js.map