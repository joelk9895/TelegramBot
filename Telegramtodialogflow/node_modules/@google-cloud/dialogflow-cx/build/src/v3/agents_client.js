...
class AgentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const exportAgentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.ExportAgentResponse');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3.Agents', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.agentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3.Agents')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3.Agents, this._opts, this._providedCustomServicePath);
