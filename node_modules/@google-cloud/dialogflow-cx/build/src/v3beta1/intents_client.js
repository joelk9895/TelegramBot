...
class IntentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const importIntentsResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ImportIntentsResponse');
        const importIntentsMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ImportIntentsMetadata');
        const exportIntentsResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportIntentsResponse');
        const exportIntentsMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportIntentsMetadata');
        this.descriptors.longrunning = {
            importIntents: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importIntentsResponse.decode.bind(importIntentsResponse), importIntentsMetadata.decode.bind(importIntentsMetadata)),
            exportIntents: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportIntentsResponse.decode.bind(exportIntentsResponse), exportIntentsMetadata.decode.bind(exportIntentsMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Intents', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.intentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Intents')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Intents, this._opts, this._providedCustomServicePath);
    ...
    updateIntent(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'intent.name': (_a = request.intent.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    importIntents(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkImportIntentsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.importIntents, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    exportIntents(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkExportIntentsProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.exportIntents, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
