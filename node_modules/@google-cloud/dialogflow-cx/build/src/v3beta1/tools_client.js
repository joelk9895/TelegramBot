 ...
 * `src/v3beta1/tools_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./tools_client_config.json");
...
class ToolsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listTools: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'tools'),
        };
        ...
        const exportToolsResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportToolsResponse');
        const exportToolsMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportToolsMetadata');
        this.descriptors.longrunning = {
            exportTools: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportToolsResponse.decode.bind(exportToolsResponse), exportToolsMetadata.decode.bind(exportToolsMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Tools', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.toolsStub) {
            return this.toolsStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.cx.v3beta1.Tools.
        this.toolsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Tools')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Tools, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of toolsStubMethods) {
            const callPromise = this.toolsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createTool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    getTool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updateTool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'tool.name': (_a = request.tool.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateTool(request, options, callback);
    }
    deleteTool(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    exportTools(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkExportToolsProgress(name) {
    ...
    listTools(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listToolsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listTools.createStream(this.innerApiCalls.listTools, request, callSettings);
    }
    /**
    ...
    listToolsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listTools.asyncIterate(this.innerApiCalls['listTools'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=tools_client.js.map