...
class EnvironmentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createEnvironmentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.Environment');
        const createEnvironmentMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        const updateEnvironmentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.Environment');
        const updateEnvironmentMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        const runContinuousTestResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.RunContinuousTestResponse');
        const runContinuousTestMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.RunContinuousTestMetadata');
        const deployFlowResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.DeployFlowResponse');
        const deployFlowMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.DeployFlowMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Environments', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.environmentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Environments')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Environments, this._opts, this._providedCustomServicePath);
    ...
    runContinuousTest(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                environment: (_a = request.environment) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    lookupEnvironmentHistory(request, optionsOrCallback, callback) {
        ...
        this.initialize();
        return this.innerApiCalls.lookupEnvironmentHistory(request, options, callback);
    }
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
    ...
    listContinuousTestResults(request, optionsOrCallback, callback) {
        ...
        this.initialize();
        return this.innerApiCalls.listContinuousTestResults(request, options, callback);
    }
    /**
     * Equivalent to `method.name.toCamelCase()`, but returns a NodeJS Stream object.
     * @param {Object} request
    ...
    listContinuousTestResultsStream(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listContinuousTestResults.createStream(this.innerApiCalls.listContinuousTestResults, request, callSettings);
    }
    /**
    ...
    listContinuousTestResultsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listContinuousTestResults.asyncIterate(this.innerApiCalls['listContinuousTestResults'], request, callSettings);
    }
    /**
