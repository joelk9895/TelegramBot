...
class TestCasesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const runTestCaseResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.RunTestCaseResponse');
        const runTestCaseMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.RunTestCaseMetadata');
        const batchRunTestCasesResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.BatchRunTestCasesResponse');
        const batchRunTestCasesMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.BatchRunTestCasesMetadata');
        const importTestCasesResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ImportTestCasesResponse');
        const importTestCasesMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ImportTestCasesMetadata');
        const exportTestCasesResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportTestCasesResponse');
        const exportTestCasesMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportTestCasesMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.TestCases', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.testCasesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.TestCases')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.TestCases, this._opts, this._providedCustomServicePath);
    ...
    updateTestCase(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'test_case.name': (_a = request.testCase.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
    ...
    calculateCoverage(request, optionsOrCallback, callback) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                agent: (_a = request.agent) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
