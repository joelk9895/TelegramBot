 ...
 * `src/v3beta1/examples_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./examples_client_config.json");
...
class ExamplesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Examples', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.examplesStub) {
            return this.examplesStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.cx.v3beta1.Examples.
        this.examplesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Examples')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Examples, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const examplesStubMethods = [
            'createExample',
            'deleteExample',
            'listExamples',
            'getExample',
        ...
        for (const methodName of examplesStubMethods) {
            const callPromise = this.examplesStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    createExample(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        ...
        this.initialize();
        return this.innerApiCalls.createExample(request, options, callback);
    }
    deleteExample(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        this.initialize();
        return this.innerApiCalls.deleteExample(request, options, callback);
    }
    ...
    updateExample(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'example.name': (_a = request.example.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updateExample(request, options, callback);
    }
     ...
     */
    close() {
        if (this.examplesStub && !this._terminated) {
            return this.examplesStub.then(stub => {
...
//# sourceMappingURL=examples_client.js.map