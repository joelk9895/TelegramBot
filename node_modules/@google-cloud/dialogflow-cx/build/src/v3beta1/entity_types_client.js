 ...
 * `src/v3beta1/entity_types_client_config.json`.
...
class EntityTypesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const exportEntityTypesResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportEntityTypesResponse');
        const exportEntityTypesMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ExportEntityTypesMetadata');
        const importEntityTypesResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ImportEntityTypesResponse');
        const importEntityTypesMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3beta1.ImportEntityTypesMetadata');
        this.descriptors.longrunning = {
            exportEntityTypes: new this._gaxModule.LongrunningDescriptor(this.operationsClient, exportEntityTypesResponse.decode.bind(exportEntityTypesResponse), exportEntityTypesMetadata.decode.bind(exportEntityTypesMetadata)),
            importEntityTypes: new this._gaxModule.LongrunningDescriptor(this.operationsClient, importEntityTypesResponse.decode.bind(importEntityTypesResponse), importEntityTypesMetadata.decode.bind(importEntityTypesMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.EntityTypes', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.entityTypesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.EntityTypes')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.EntityTypes, this._opts, this._providedCustomServicePath);
    ...
    exportEntityTypes(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkExportEntityTypesProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.exportEntityTypes, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
    importEntityTypes(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    async checkImportEntityTypesProgress(name) {
        const request = new this._gaxModule.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new this._gaxModule.Operation(operation, this.descriptors.longrunning.importEntityTypes, this._gaxModule.createDefaultBackoffSettings());
        return decodeOperation;
    }
