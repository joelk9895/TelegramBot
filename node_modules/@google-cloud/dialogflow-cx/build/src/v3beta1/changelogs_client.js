...
exports.ChangelogsClient = void 0;
const jsonProtos = require("../../protos/protos.json");
/**
 * Client JSON configuration object, loaded from
 * `src/v3beta1/changelogs_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./changelogs_client_config.json");
const version = require('../../../package.json').version;
/**
 *  Service for managing
 *  {@link protos.google.cloud.dialogflow.cx.v3beta1.Changelog|Changelogs}.
 * @class
 * @memberof v3beta1
 */
class ChangelogsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listChangelogs: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'changelogs'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Changelogs', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.changelogsStub) {
            return this.changelogsStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.cx.v3beta1.Changelogs.
        this.changelogsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Changelogs')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Changelogs, this._opts, this._providedCustomServicePath);
        // Iterate over each of the methods that the service provides
        // and create an API call method for each.
        const changelogsStubMethods = ['listChangelogs', 'getChangelog'];
        for (const methodName of changelogsStubMethods) {
            const callPromise = this.changelogsStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getChangelog(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    listChangelogs(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.cx.v3beta1.Changelog|Changelog} on 'data' event.
     ...
     */
    listChangelogsStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listChangelogs.createStream(this.innerApiCalls.listChangelogs, request, callSettings);
    }
    /**
     ...
     *   {@link protos.google.cloud.dialogflow.cx.v3beta1.Changelog|Changelog}. The API will be called under the hood as needed, once per the page,
    ...
    listChangelogsAsync(request, options) {
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listChangelogs.asyncIterate(this.innerApiCalls['listChangelogs'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=changelogs_client.js.map