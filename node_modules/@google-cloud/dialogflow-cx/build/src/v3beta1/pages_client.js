 ...
 * `src/v3beta1/pages_client_config.json`.
 * This file defines retry strategy and timeouts for all API methods in this library.
 */
const gapicConfig = require("./pages_client_config.json");
...
class PagesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        this.descriptors.page = {
            listPages: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'pages'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3beta1.Pages', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        if (this.pagesStub) {
            return this.pagesStub;
        }
        // Put together the "service stub" for
        // google.cloud.dialogflow.cx.v3beta1.Pages.
        this.pagesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3beta1.Pages')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3beta1.Pages, this._opts, this._providedCustomServicePath);
        ...
        for (const methodName of pagesStubMethods) {
            const callPromise = this.pagesStub.then(stub => (...args) => {
                if (this._terminated) {
    ...
    getPage(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
    ...
    createPage(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    updatePage(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
        ...
        options.otherArgs.headers['x-goog-request-params'] =
            this._gaxModule.routingHeader.fromParams({
                'page.name': (_a = request.page.name) !== null && _a !== void 0 ? _a : '',
            });
        this.initialize();
        return this.innerApiCalls.updatePage(request, options, callback);
    }
    deletePage(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
    ...
    listPages(request, optionsOrCallback, callback) {
        var _a;
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
     ...
     */
    listPagesStream(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        this.initialize();
        return this.descriptors.page.listPages.createStream(this.innerApiCalls.listPages, request, callSettings);
    }
    /**
     ...
     */
    listPagesAsync(request, options) {
        var _a;
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        ...
        const callSettings = defaultCallSettings.merge(options);
        this.initialize();
        return this.descriptors.page.listPages.asyncIterate(this.innerApiCalls['listPages'], request, callSettings);
    }
    /**
...
//# sourceMappingURL=pages_client.js.map