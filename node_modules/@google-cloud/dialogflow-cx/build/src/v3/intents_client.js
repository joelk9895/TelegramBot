...
class IntentsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const importIntentsResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.ImportIntentsResponse');
        const importIntentsMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.ImportIntentsMetadata');
        const exportIntentsResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.ExportIntentsResponse');
        const exportIntentsMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.ExportIntentsMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3.Intents', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.intentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3.Intents')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3.Intents, this._opts, this._providedCustomServicePath);
