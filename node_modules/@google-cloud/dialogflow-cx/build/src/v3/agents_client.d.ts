...
/**
 *  Service for managing {@link protos.google.cloud.dialogflow.cx.v3.Agent|Agents}.
 * @class
 * @memberof v3
 */
export declare class AgentsClient {
     ...
     *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.cx.v3.Agent|Agent}.
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.cx.v3.AgentValidationResult|AgentValidationResult}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is an object representing {@link protos.google.cloud.dialogflow.cx.v3.GenerativeSettings|GenerativeSettings}.
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v3/agents.get_generative_settings.js</caption>
     * region_tag:dialogflow_v3_generated_Agents_GetGenerativeSettings_async
     */
    getGenerativeSettings(request?: protos.google.cloud.dialogflow.cx.v3.IGetGenerativeSettingsRequest, options?: CallOptions): Promise<[
        protos.google.cloud.dialogflow.cx.v3.IGenerativeSettings,
        (protos.google.cloud.dialogflow.cx.v3.IGetGenerativeSettingsRequest | undefined),
        {} | undefined
    ]>;
    getGenerativeSettings(request: protos.google.cloud.dialogflow.cx.v3.IGetGenerativeSettingsRequest, options: CallOptions, callback: Callback<protos.google.cloud.dialogflow.cx.v3.IGenerativeSettings, protos.google.cloud.dialogflow.cx.v3.IGetGenerativeSettingsRequest | null | undefined, {} | null | undefined>): void;
    getGenerativeSettings(request: protos.google.cloud.dialogflow.cx.v3.IGetGenerativeSettingsRequest, callback: Callback<protos.google.cloud.dialogflow.cx.v3.IGenerativeSettings, protos.google.cloud.dialogflow.cx.v3.IGetGenerativeSettingsRequest | null | undefined, {} | null | undefined>): void;
    /**
     * Updates the generative settings for the agent.
     *
     * @param {Object} request
     *   The request object that will be sent.
     * @param {google.cloud.dialogflow.cx.v3.GenerativeSettings} request.generativeSettings
     ...
     *   Please see the {@link https://github.com/googleapis/gax-nodejs/blob/master/client-libraries.md#regular-methods | documentation }
     *   for more details and examples.
     * @example <caption>include:samples/generated/v3/agents.update_generative_settings.js</caption>
     * region_tag:dialogflow_v3_generated_Agents_UpdateGenerativeSettings_async
     */
    updateGenerativeSettings(request?: protos.google.cloud.dialogflow.cx.v3.IUpdateGenerativeSettingsRequest, options?: CallOptions): Promise<[
        protos.google.cloud.dialogflow.cx.v3.IGenerativeSettings,
        (protos.google.cloud.dialogflow.cx.v3.IUpdateGenerativeSettingsRequest | undefined),
        {} | undefined
    ]>;
    ...
    updateGenerativeSettings(request: protos.google.cloud.dialogflow.cx.v3.IUpdateGenerativeSettingsRequest, callback: Callback<protos.google.cloud.dialogflow.cx.v3.IGenerativeSettings, protos.google.cloud.dialogflow.cx.v3.IUpdateGenerativeSettingsRequest | null | undefined, {} | null | undefined>): void;
    /**
     ...
     * - `response`:
     * {@link protos.google.cloud.dialogflow.cx.v3.ExportAgentResponse|ExportAgentResponse}
     *
     * @param {Object} request
     *   The request object that will be sent.
     * @param {string} request.name
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Promise} - The promise which resolves to an array.
     *   The first element of the array is Array of {@link protos.google.cloud.dialogflow.cx.v3.Agent|Agent}.
     ...
     *   Call options. See {@link https://googleapis.dev/nodejs/google-gax/latest/interfaces/CallOptions.html|CallOptions} for more details.
     * @returns {Stream}
     *   An object stream which emits an object representing {@link protos.google.cloud.dialogflow.cx.v3.Agent|Agent} on 'data' event.
     *   The client library will perform auto-pagination by default: it will call the API as many
     ...
     *   {@link protos.google.cloud.dialogflow.cx.v3.Agent|Agent}. The API will be called under the hood as needed, once per the page,
