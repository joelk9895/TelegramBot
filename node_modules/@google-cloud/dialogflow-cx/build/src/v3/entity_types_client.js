...
class EntityTypesClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const exportEntityTypesResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.ExportEntityTypesResponse');
        const exportEntityTypesMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.ExportEntityTypesMetadata');
        const importEntityTypesResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.ImportEntityTypesResponse');
        const importEntityTypesMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.ImportEntityTypesMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3.EntityTypes', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.entityTypesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3.EntityTypes')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3.EntityTypes, this._opts, this._providedCustomServicePath);
