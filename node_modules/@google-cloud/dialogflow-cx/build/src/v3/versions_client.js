...
class VersionsClient {
    ...
    constructor(opts, gaxInstance) {
        ...
        const createVersionResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.Version');
        const createVersionMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.cx.v3.CreateVersionOperationMetadata');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.cx.v3.Versions', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.versionsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.cx.v3.Versions')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.cx.v3.Versions, this._opts, this._providedCustomServicePath);
